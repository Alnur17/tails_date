...
//                 ),
//                 onPressed: () {
//                     // if (messageController.text.trim().isNotEmpty && widget.chatId != null) {
//                     //   controller.sendMessage(widget.chatId!, messageController.text.trim());
...
class _MessageViewState extends State<MessageView> {
  ...
  void initState() {
    ...
    controller.messageBody.listen((_) {
