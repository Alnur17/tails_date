...
class Data {
  ...
  final List<GuestPostDatum> data;
  final Meta? meta;

  factory Data.fromJson(Map<String, dynamic> json){
    return Data(
      data: json["data"] == null ? [] : List<GuestPostDatum>.from(json["data"]!.map((x) => GuestPostDatum.fromJson(x))),
...
class GuestPostDatum {
  ...
  factory GuestPostDatum.fromJson(Map<String, dynamic> json){
    return GuestPostDatum(
      id: json["_id"],
