...
//                       child: AttributeTile(
//                         label: 'Age',
//                         value: profileController.profileData.value!.data?.age
//                             ?.toString() ??
//                             'N/A',
//                       ),
//                     ),
...
//                     ),
//                     title: Text(
//                       profileController.profileData.value!.data?.ownerName ??
//                           'Unknown',
//                       style: h4,
//                     ),
//                     subtitle: Text(
...
//                           ),
//                         ),
//                         (profileController.profileData.value!.data?.gallery
//                             .isEmpty ??
//                             true)
//                             ? Padding(
//                           padding: const EdgeInsets.symmetric(
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () {
                          Get.to(() => EditProfileView(
                            ...
                            initialAge: profileController.profileData.value!.data?.age?.toString() ?? '',
