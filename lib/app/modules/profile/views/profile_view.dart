...
class _ProfileViewState extends State<ProfileView> {
  ...
  void initState() {
    super.initState();
    homeController.fetchMyPosts(); // Fetch my posts when the view is initialized
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          GestureDetector(
            onTap: () {
              Get.to(() => ProfileSettingView(
                ...
                name: profileController.profileData.value!.data?.name ?? 'N/A',
                location: profileController.profileData.value!.data?.location ??
                    'Location not set',
              ));
            },
            child: Padding(
      ...
      body: Obx(
            () => profileController.isLoading.value || homeController.isLoading.value
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: profileController.coverImage.value != null
                              ? File(profileController.coverImage.value!.path).existsSync()
                              ? FileImage(File(profileController.coverImage.value!.path))
                              : const AssetImage(AppImages.groupOfDogs) as ImageProvider
                              : profileController.profileData.value?.data?.coverImage != null
                              ? NetworkImage(profileController.profileData.value!.data!.coverImage!)
                              : const AssetImage(AppImages.groupOfDogs),
                    ...
                    Positioned(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage: profileController.selectedImage.value != null
                            ? File(profileController.selectedImage.value!.path).existsSync()
                            ? FileImage(File(profileController.selectedImage.value!.path))
                            : const AssetImage(AppImages.profileImage) as ImageProvider
                            : profileController.profileData.value?.data?.image != null
                            ? NetworkImage(profileController.profileData.value!.data!.image!)
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () {
                          Get.to(() => EditProfileView(
                            initialName: profileController.profileData.value!.data?.name ?? '',
                            initialGender: profileController.profileData.value!.data?.gender ?? '',
                            initialLocation: profileController.profileData.value!.data?.location ?? '',
                            initialAge: profileController.profileData.value!.data?.age,
                            initialCategory: profileController.profileData.value!.data?.category ?? '',
                            initialPetInfo: profileController.profileData.value!.data?.petInfo ?? '',
                            initialOwnerName: profileController.profileData.value!.data?.ownerName ?? '',
                ...
                sh8,
                Text(
                  profileController.profileData.value!.data?.petInfo ??
                      'N/A',
                  style: h4,
                ),
                sh16,
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    leading: CircleAvatar(
                      radius: 30,
                      backgroundImage: profileController.ownerImage.value != null
                          ? File(profileController.ownerImage.value!.path).existsSync()
                          ? FileImage(File(profileController.ownerImage.value!.path))
                          : null
                          : profileController.profileData.value?.data?.ownerImage != null
                          ? NetworkImage(profileController.profileData.value!.data!.ownerImage!)
                          : null,
                ...
                if (showPosts)
                  homeController.myPosts.isEmpty
                    ...
                    child: Padding(
                      ...
                      child: Image.asset(AppImages.profileBack, scale: 4),
                    ),
                  )
                      : ListView.builder(
                    shrinkWrap: true,
                    ...
                    itemBuilder: (context, index) {
                      final post = homeController.myPosts[index];
                      return Padding(
                  ...
                  profileController.myReelsData.isEmpty
                    ...
                    itemCount: profileController.myReelsData.length,
                    itemBuilder: (context, index) {
                      final reel = profileController.myReelsData[index];
                              ...
                              Positioned.fill(
                                child: ClipRRect(
                                  ...
                                  child: FutureBuilder<dynamic>(
                                    future: generateThumbnail(reel.video ?? ''),
                    ...
                    Column(
                      children: [
                        ...
                        (profileController.profileData.value!.data?.gallery.isEmpty ??
                            true)
                            ? Padding(
                          padding: const EdgeInsets.symmetric(vertical: 32),
                          child: Image.asset(AppImages.profileBack, scale: 4),
                          ...
                          itemCount: profileController.profileData.value!.data?.gallery.length ?? 0,
                          itemBuilder: (context, index) {
                            final imagePath = profileController.profileData.value!.data!.gallery[index];
                            return Container(
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(12),
                                color: AppColors.white,
                                ...
                                children: [
                                  Positioned.fill(
                                    child: ClipRRect(
                                      borderRadius: BorderRadius.circular(12),
                                      child: Image.network(
                                        profileController.profileData.value!.data!.gallery[index],
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ),
                                  Positioned(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        profileController.patchRemovePetGalleryImage(imagePath);
                                      },
                                      child: Container(
                      ...
                      Column(
                        children: [
                          ...
                          (profileController.profileData.value!.data?.ownerGallery.isEmpty ??
                              true)
                              ? Padding(
                            padding: const EdgeInsets.symmetric(vertical: 32),
                            child: Image.asset(AppImages.profileBack, scale: 4),
                            ...
                            itemCount: profileController.profileData.value!.data?.ownerGallery.length ?? 0,
                            itemBuilder: (context, index) {
                              final imagePath = profileController.profileData.value!.data!.ownerGallery[index];
                              return Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(12),
                                  color: AppColors.white,
                                  ...
                                  children: [
                                    Positioned.fill(
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(12),
                                        child: Image.network(
                                          profileController.profileData.value!.data!.ownerGallery[index],
                                          fit: BoxFit.cover,
                                        ),
                                      ),
                                    ),
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onTap: () {
                                          profileController.patchRemoveOwnerGalleryImage(imagePath);
                                        },
                                        child: Container(
                                          padding: EdgeInsets.all(6),
                                          decoration: ShapeDecoration(
