...
class _EditProfileViewState extends State<EditProfileView> {
  ...
  Future<void> pickImage(ImageSource source, String type) async {
    try {
      ...
      log('Error picking image: $e');
      kSnackBar(
          message: 'Error_Selecting_Image'.trParams({'0': e.toString()}),
          bgColor: AppColors.orange);
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                  ...
                  onTap: () {
                    setState(() {
                      if (controller.selectedImage.value != null ||
                        ...
                        controller.coverImage.value = null;
                        kSnackBar(
                            message: 'Images_Cleared'.tr,
                            bgColor: AppColors.green);
                      } else {
                        kSnackBar(
                            message: 'No_Images_To_Clear'.tr,
                            bgColor: AppColors.orange);
                      }
                    });
                  },
              ...
              sh16,
              // Location
              Text('Location'.tr, style: h2.copyWith(fontSize: 18)),
              sh8,
              CustomTextField(
                controller: locationController,
                containerColor: AppColors.white,
                hintText: 'Enter_Your_Pet_Location'.tr,
              ),
              sh16,
              // Gender
              ...
              sh16,
              // Pet Owner Profile Picture
              Text('Pet_Owner_Profile_Picture'.tr,
                  style: h2.copyWith(fontSize: 18)),
              sh12,
              Stack(
                alignment: Alignment.center,
              ...
              sh16,
              // Pet Owner Name
              Text('Pet_Owner_Name'.tr, style: h2.copyWith(fontSize: 18)),
              sh8,
              CustomTextField(
                controller: ownerNameController,
                containerColor: AppColors.white,
              ...
              sh16,
              // Relationship
              Text('Relationship'.tr, style: h2.copyWith(fontSize: 18)),
              sh8,
              CustomDropdown(
                value: selectedOwnerRelationshipStatus,
                items: ['Single', 'Married'],
                hintText: 'Select_Your_Relationship_Status'.tr,
                onChanged: (value) {
                  setState(() {
                    selectedOwnerRelationshipStatus = value;
                  });
